...
export {
  scoreColor, scoreBand, vitalBand, deltaOf, matchesAuditQuery, groupAudits, parseAuditDescription,
  AUDIT_CATEGORY_LABEL, AUDIT_CATEGORY_ORDER, findFrameAt, findClosestFrameIndex, mergeAnalysisInsights, SCORE_GOOD, SCORE_WARN, SCORE_BAD,
...
export { ElapsedClock } from './ui/ElapsedClock'
export { DEVICE_MODES, PRECISION_MODES, formatElapsed } from './auditModes'
export { ScoreRing } from './ui/ScoreRing'
export { drawShareCard, shareCardBlob, shareCardFilename } from './shareCard'
export { FormFactorToggle } from './ui/FormFactorToggle'
export { AvgBadge } from './ui/AvgBadge'
export { PrecisionToggle } from './ui/PrecisionToggle'
...
export { useRunningAuditsStore } from './model/runningAuditsStore'
export type { RunningAudit } from './model/runningAuditsStore'
