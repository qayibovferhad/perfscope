  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'ld-amber-wash':    'var(--ld-amber-wash)',
        'ld-amber-soft':    'var(--ld-amber-soft)',
        'ld-amber-fill':    'var(--ld-amber-fill)',
        'ld-amber-line':    'var(--ld-amber-line)',
        'ld-amber-strong':  'var(--ld-amber-strong)',
        'ld-rose':          'var(--ld-rose)',
        'ld-rose-wash':     'var(--ld-rose-wash)',
        'ld-rose-soft':     'var(--ld-rose-soft)',
        'ld-rose-fill':     'var(--ld-rose-fill)',
        'ld-rose-line':     'var(--ld-rose-line)',
        'ld-rose-strong':   'var(--ld-rose-strong)',
